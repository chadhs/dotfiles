...
Raise GC during package load, then restore a sane threshold at the end of this file.

#+BEGIN_SRC emacs-lisp
  (setq gc-cons-threshold (* 200 1024 1024) ; ~200MB while loading
...
#+BEGIN_SRC emacs-lisp
  ;; Restore a sane GC threshold after package load
