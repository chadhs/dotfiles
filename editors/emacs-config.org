...
#+BEGIN_SRC emacs-lisp
  (use-package restart-emacs
    ...
    :init
    ;;; keybinds pre load
    (evil-leader/set-key "re" #'restart-emacs)) ; (r)estart (e)macs
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package evil
    ...
    ;; move to next / prev window (force override bindings from all modes)
    (bind-keys*
     ("C-k" . evil-window-up)
    ...
    (evil-leader/set-key "wc" #'evil-window-delete) ; (w)indow (c)lose
    )
...
#+BEGIN_SRC emacs-lisp
  ...
  ;;; allow foFf" #'find-file                     ; (F)ind (f)ile
