...
#+BEGIN_SRC emacs-lisp
  (use-package deft
    ...
    (defvar --user-notes-dir (concat --user-home-dir "/tech-notes"))
...
*** indentation highlighting
    #+BEGIN_SRC emacs-lisp
      (use-package highlight-indentation
        :defer t
        :hook ((pug-mode . highlight-indentation-mode)
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package js2-mode
    ...
    (setq js2-mode-show-parse-errors nil
          ...
          js-indent-level 2)
    (electric-pair-mode 1)
    (add-hook 'flycheck-mode-hook #'cs/use-eslint-from-node-modules)
    ;;; keybinds on load
...
*** use localized eslint
    #+BEGIN_SRC emacs-lisp
      (defun cs/use-eslint-from-node-modules ()
