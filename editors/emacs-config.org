...
#+BEGIN_SRC emacs-lisp
  (use-package clojure-mode
    ...
    (add-hook 'clojure-mode-hook (lambda ()
                                   ...
                                   (yas-minor-mode)))
    :config
    ;; this customer repl setup is for re-frame/reagent clojurescript development
...
#+BEGIN_SRC emacs-lisp
  (defun open-dired-at-current-dir ()
    (interactive)
...
#+BEGIN_SRC emacs-lisp
  ...
  (evil-leader/set-key "Fd" #'open-dired-at-current-dir) ; (F)ind via (d)ired
#+END_SRC
